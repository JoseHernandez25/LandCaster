...
{
    public class DrawerSlideConfiguration: IEntityTypeConfiguration<DrawerSlide>
    {
        public void Configure(EntityTypeBuilder<DrawerSlide> builder)
        {
            ...
            .IsRequired(false);
            builder.Property(prop => prop.IsSimple)
          .IsRequired()  // Campo requerido
          .HasDefaultValue(true);
            builder.HasQueryFilter(prop => prop.DeletedAt == null);
            builder.HasOne(c => c.Brand)
       .WithMany(b => b.DrawerSlides) // Asegúrate de que estás usando la propiedad correcta de navegación
