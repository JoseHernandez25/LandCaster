        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Creditor = table.Column<byte>(type: "tinyint", nullable: false),
                    InformationableId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<int>(type: "int", nullable: false), //ejemplo de como tiene que ser
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourierSupplier", x => new { x.CouriersId, x.SuppliersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FactorySupplier", x => new { x.FactoriesId, x.SuppliersId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourierSupplier_SuppliersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FactorySupplier_SuppliersId",
