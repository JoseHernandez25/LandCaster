...
namespace LandCaster.DAL.Migrations
{
    ...
    [Migration("20240426033839_Routes")]
            ...
            modelBuilder.Entity("LandCaster.Entities.Entities.HingeComponent", b =>
                {
                    ...
                    b.HasOne("LandCaster.Entities.Entities.Currencie", "Curriencie")
                        .WithMany()
                        .HasForeignKey("CurriencieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Brand");

                    b.Navigation("Curriencie");
                });
