        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_Factories_FactoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Quantity = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ProductEventId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductEventDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductEventDetails_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductEventDetails_InventoryId",
                table: "ProductEventDetails",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductEventDetails_ProductEventId",
                table: "ProductEventDetails",
